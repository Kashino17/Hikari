...
test("upsertPage preserves existing local_path when called again without one", () => {
  upsertSeries(db, {
    source: "onepiecetube", sourceSlug: "one-piece",
    title: "One Piece", sourceUrl: "https://x",
  });
  upsertChapter(db, {
    source: "onepiecetube", seriesSlug: "one-piece",
    number: 1095, sourceUrl: "https://x",
  });
  upsertPage(db, {
    source: "onepiecetube", seriesSlug: "one-piece",
    chapterNumber: 1095, pageNumber: 1,
